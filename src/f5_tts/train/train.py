...
dataset_name = "EmiliaPetite_dataset_ZH_EN"

# -------------------------- Training Settings -------------------------- #

exp_name = "F5TTS_Base"  # F5TTS_Base | E2TTS_Base
wandb_name = "F5TTS_Base_with_validation"
...
#batch_size_type = "sample"  # "frame" or "sample" # **** mine # ASA MERGE
max_samples = 64 
...
def main():
    ...
    print('batch_size_type: ', batch_size_type)
    trainer = Trainer(
        model,
        epochs,
        learning_rate,
